...
var bPath = [];
  function raiseA(a,b){
    ...
    raiseB(a,b);
    if(!commonAnc&&a.parentNode.nodeType!=9){
		bPath = [];
  ...
  raiseA(a,b);
return [commonAnc,aPath,bPath];
}

function findTemplateParent(p){
...
function getTempl2bApplied(o,t,r,at){
