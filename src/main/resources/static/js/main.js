...
window.onload = function () {
	...
	function setDataset(set) {
		...
		var cols = document.querySelectorAll('#datasetHolder .divBox');
	...
	function submitListener(reqStr, resStr) {
		...
		var cols = document.querySelectorAll('#reqHolder .divBox');
		[].forEach.call(cols, function (col) {
			col.addEventListener('dragstart', handleDragStart, false);
			col.addEventListener('dragend', handleDragEnd, false);
			col.addEventListener('dblclick', tglCollapse, false);
		...
		var cols = document.querySelectorAll('#resHolder .divBox');
		[].forEach.call(cols, function (col) {
			col.addEventListener('dragstart', handleDragStart, false);
			col.addEventListener('dragenter', handleDragEnter, false);
			col.addEventListener('dragover', handleDragOver, false);
